...
*/
void playnote_dmadv(int a,bool &hh,bool &sd,bool &bd,bool &ht,bool &lt,bool &cy){
	#ifdef EXCESSIVE
	printf("playnote_dmadv\n");
	#endif
	if (drumdiff==1){
		...
		if (testmeasure+(almostlv*currbpm/150)<songposition+(entiresongoffset*currbpm)){
			if (!songs[thesong].advnoteplayed[a]){
				if (songs[thesong].advnotesound[a]!=NULL){
					if (strcmp(songs[thesong].advnotetype[a],"hh")==0||strcmp(songs[thesong].advnotetype[a],"11")==0){
						if (!songs[thesong].advnoteplayed[a]){
							gpmiss++;
							gpcurrcombo=0;
					...
					if (strcmp(songs[thesong].advnotetype[a],"sd")==0||strcmp(songs[thesong].advnotetype[a],"12")==0){
						if (!songs[thesong].advnoteplayed[a]){
							gpmiss++;
							gpcurrcombo=0;
					...
					if (strcmp(songs[thesong].advnotetype[a],"bd")==0||strcmp(songs[thesong].advnotetype[a],"13")==0){
						if (!songs[thesong].advnoteplayed[a]){
							gpmiss++;
							gpcurrcombo=0;
					...
					if (strcmp(songs[thesong].advnotetype[a],"ht")==0||strcmp(songs[thesong].advnotetype[a],"14")==0){
						if (!songs[thesong].advnoteplayed[a]){
							gpmiss++;
							gpcurrcombo=0;
					...
					if (strcmp(songs[thesong].advnotetype[a],"lt")==0||strcmp(songs[thesong].advnotetype[a],"15")==0){
						if (!songs[thesong].advnoteplayed[a]){
							gpmiss++;
							gpcurrcombo=0;
					...
					if (strcmp(songs[thesong].advnotetype[a],"cy")==0||strcmp(songs[thesong].advnotetype[a],"16")==0){
						if (!songs[thesong].advnoteplayed[a]){
							gpmiss++;
							gpcurrcombo=0;
		...
		if (testmeasure-(almostlv*currbpm/150)<songposition+(entiresongoffset*currbpm)){
			if (!songs[thesong].advnoteplayed[a]){
				if (songs[thesong].advnotesound[a]!=NULL){
					...
					if (strcmp(songs[thesong].advnotetype[a],"sd")==0||strcmp(songs[thesong].advnotetype[a],"12")==0){
						if (snarets>=testmeasure-(almostlv*currbpm/150)&&!songs[thesong].advnoteplayed[a]){
							if (!sd){
					...
					if (strcmp(songs[thesong].advnotetype[a],"hh")==0||strcmp(songs[thesong].advnotetype[a],"11")==0){
						if (hihatts>=testmeasure-(almostlv*currbpm/150)&&!songs[thesong].advnoteplayed[a]){
							if (!hh){
								playsound(marmot+256,voldrum);
								lasthihat=marmot;
								hihatpressed=false;
					...
					if (strcmp(songs[thesong].advnotetype[a],"bd")==0||strcmp(songs[thesong].advnotetype[a],"13")==0){
						if (bassts>=testmeasure-(almostlv*currbpm/150)&&!songs[thesong].advnoteplayed[a]){
							if (!bd){
								playsound(marmot+256,voldrum);
								lastbass=marmot;
								basspressed=false;
					...
					if (strcmp(songs[thesong].advnotetype[a],"ht")==0||strcmp(songs[thesong].advnotetype[a],"14")==0){
						if (hitomts>=testmeasure-(almostlv*currbpm/150)&&!songs[thesong].advnoteplayed[a]){
							if (!ht){
								playsound(marmot+256,voldrum);
								lasthitom=marmot;
								hitompressed=false;
					...
					if (strcmp(songs[thesong].advnotetype[a],"lt")==0||strcmp(songs[thesong].advnotetype[a],"15")==0){
						if (lotomts>=testmeasure-(almostlv*currbpm/150)&&!songs[thesong].advnoteplayed[a]){
							if (!lt){
								playsound(marmot+256,voldrum);
								lastlotom=marmot;
								lotompressed=false;
					...
					if (strcmp(songs[thesong].advnotetype[a],"cy")==0||strcmp(songs[thesong].advnotetype[a],"16")==0){
						if (cymbalts>=testmeasure-(almostlv*currbpm/150)&&!songs[thesong].advnoteplayed[a]){
							if (!cy){
								playsound(marmot+256,voldrum);
								lastcymbal=marmot;
								cymbalpressed=false;
