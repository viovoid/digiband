...
*/
void playnote_dmbas(int a,bool &hh,bool &sd,bool &bd,bool &ht,bool &lt,bool &cy){
	#ifdef EXCESSIVE
	printf("playnote_dmbas\n");
	#endif
	if (drumdiff==0){
		...
		if (testmeasure+(almostlv*currbpm/150)<songposition+(entiresongoffset*currbpm)){
			if (!songs[thesong].basnoteplayed[a]){
				if (songs[thesong].basnotesound[a]!=NULL){
					if (strcmp(songs[thesong].basnotetype[a],"hh")==0||strcmp(songs[thesong].basnotetype[a],"11")==0){
						if (!songs[thesong].basnoteplayed[a]){
							gpmiss++;
							gpcurrcombo=0;
					...
					if (strcmp(songs[thesong].basnotetype[a],"sd")==0||strcmp(songs[thesong].basnotetype[a],"12")==0){
						if (!songs[thesong].basnoteplayed[a]){
							gpmiss++;
							gpcurrcombo=0;
					...
					if (strcmp(songs[thesong].basnotetype[a],"bd")==0||strcmp(songs[thesong].basnotetype[a],"13")==0){
						if (!songs[thesong].basnoteplayed[a]){
							gpmiss++;
							gpcurrcombo=0;
					...
					if (strcmp(songs[thesong].basnotetype[a],"ht")==0||strcmp(songs[thesong].basnotetype[a],"14")==0){
						if (!songs[thesong].basnoteplayed[a]){
							gpmiss++;
							gpcurrcombo=0;
					...
					if (strcmp(songs[thesong].basnotetype[a],"lt")==0||strcmp(songs[thesong].basnotetype[a],"15")==0){
						if (!songs[thesong].basnoteplayed[a]){
							gpmiss++;
							gpcurrcombo=0;
					...
					if (strcmp(songs[thesong].basnotetype[a],"cy")==0||strcmp(songs[thesong].basnotetype[a],"16")==0){
						if (!songs[thesong].basnoteplayed[a]){
							gpmiss++;
							gpcurrcombo=0;
		...
		if (testmeasure-(almostlv*currbpm/150)<songposition+(entiresongoffset*currbpm)){
			if (!songs[thesong].basnoteplayed[a]){
				if (songs[thesong].basnotesound[a]!=NULL){
					...
					if (strcmp(songs[thesong].basnotetype[a],"sd")==0||strcmp(songs[thesong].basnotetype[a],"12")==0){
						if (snarets>=testmeasure-(almostlv*currbpm/150)&&!songs[thesong].basnoteplayed[a]){
							if (!sd){
					...
					if (strcmp(songs[thesong].basnotetype[a],"hh")==0||strcmp(songs[thesong].basnotetype[a],"11")==0){
						if (hihatts>=testmeasure-(almostlv*currbpm/150)&&!songs[thesong].basnoteplayed[a]){
							if (!hh){
								playsound(marmot+256,voldrum);
								lasthihat=marmot;
								hihatpressed=false;
					...
					if (strcmp(songs[thesong].basnotetype[a],"bd")==0||strcmp(songs[thesong].basnotetype[a],"13")==0){
						if (bassts>=testmeasure-(almostlv*currbpm/150)&&!songs[thesong].basnoteplayed[a]){
							if (!bd){
								playsound(marmot+256,voldrum);
								lastbass=marmot;
								basspressed=false;
					...
					if (strcmp(songs[thesong].basnotetype[a],"ht")==0||strcmp(songs[thesong].basnotetype[a],"14")==0){
						if (hitomts>=testmeasure-(almostlv*currbpm/150)&&!songs[thesong].basnoteplayed[a]){
							if (!ht){
								playsound(marmot+256,voldrum);
								lasthitom=marmot;
								hitompressed=false;
					...
					if (strcmp(songs[thesong].basnotetype[a],"lt")==0||strcmp(songs[thesong].basnotetype[a],"15")==0){
						if (lotomts>=testmeasure-(almostlv*currbpm/150)&&!songs[thesong].basnoteplayed[a]){
							if (!lt){
								playsound(marmot+256,voldrum);
								lastlotom=marmot;
								lotompressed=false;
					...
					if (strcmp(songs[thesong].basnotetype[a],"cy")==0||strcmp(songs[thesong].basnotetype[a],"16")==0){
						if (cymbalts>=testmeasure-(almostlv*currbpm/150)&&!songs[thesong].basnoteplayed[a]){
							if (!cy){
								playsound(marmot+256,voldrum);
								lastcymbal=marmot;
								cymbalpressed=false;
