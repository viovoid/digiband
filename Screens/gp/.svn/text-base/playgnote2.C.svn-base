...
*/
void playnote_g1ext(int a,bool &gb,bool &gg,bool &ggb,bool &gr,bool &grb,bool &grg,bool &grgb,bool &gw,bool &go){
	#ifdef EXCESSIVE
	printf("playnote_g1ext\n");
	#endif
	if (guitar1treb){
		if (guit1diff==2){
			...
			if (testmeasure+(almostlv*currbpm/150)<songposition+(entiresongoffset*currbpm)){
				if (!songs[thesong].g1extnoteplayed[a]){
					if (songs[thesong].extnotesound[a]!=NULL){
						...
						if (strcmp(songs[thesong].extnotetype[a],"20")==0||strcmp(songs[thesong].extnotetype[a],"g0")==0){
							if (!songs[thesong].g1extnoteplayed[a]){
								...
								songs[thesong].g1extnoteplayed[a]=true;
			...
			if (testmeasure-(almostlv*currbpm/150)<songposition+(entiresongoffset*currbpm)){
				if (!songs[thesong].g1extnoteplayed[a]){
					if (songs[thesong].extnotesound[a]!=NULL){
						...
						if (strcmp(songs[thesong].extnotetype[a],"20")==0||strcmp(songs[thesong].extnotetype[a],"g0")==0){
							if (g1ots>=testmeasure-(almostlv*currbpm/150)&&!songs[thesong].g1extnoteplayed[a]){
								if (!go){
						...
						if (strcmp(songs[thesong].extnotetype[a],"21")==0||strcmp(songs[thesong].extnotetype[a],"g1")==0){
							if (g1bts>=testmeasure-(almostlv*currbpm/150)&&!songs[thesong].g1extnoteplayed[a]){
								if (!gb){
									playsound(marmot+256,volguit);
									songs[thesong].g1extnoteplayed[a]=true;
									gb=true;
						...
						if (strcmp(songs[thesong].extnotetype[a],"22")==0||strcmp(songs[thesong].extnotetype[a],"g2")==0){
							if (g1gts>=testmeasure-(almostlv*currbpm/150)&&!songs[thesong].g1extnoteplayed[a]){
								if (!gg){
									playsound(marmot+256,volguit);
									songs[thesong].g1extnoteplayed[a]=true;
									gg=true;
						...
						if (strcmp(songs[thesong].extnotetype[a],"23")==0||strcmp(songs[thesong].extnotetype[a],"g3")==0){
							if (g1gbts>=testmeasure-(almostlv*currbpm/150)&&!songs[thesong].g1extnoteplayed[a]){
								if (!ggb){
									playsound(marmot+256,volguit);
									songs[thesong].g1extnoteplayed[a]=true;
									ggb=true;
						...
						if (strcmp(songs[thesong].extnotetype[a],"24")==0||strcmp(songs[thesong].extnotetype[a],"g4")==0){
							if (g1rts>=testmeasure-(almostlv*currbpm/150)&&!songs[thesong].g1extnoteplayed[a]){
								if (!gr){
									playsound(marmot+256,volguit);
									songs[thesong].g1extnoteplayed[a]=true;
									gr=true;
						...
						if (strcmp(songs[thesong].extnotetype[a],"25")==0||strcmp(songs[thesong].extnotetype[a],"g5")==0){
							if (g1rbts>=testmeasure-(almostlv*currbpm/150)&&!songs[thesong].g1extnoteplayed[a]){
								if (!grb){
									playsound(marmot+256,volguit);
									songs[thesong].g1extnoteplayed[a]=true;
									grb=true;
						...
						if (strcmp(songs[thesong].extnotetype[a],"26")==0||strcmp(songs[thesong].extnotetype[a],"g6")==0){
							if (g1rgts>=testmeasure-(almostlv*currbpm/150)&&!songs[thesong].g1extnoteplayed[a]){
								if (!grg){
									playsound(marmot+256,volguit);
									songs[thesong].g1extnoteplayed[a]=true;
									grg=true;
						...
						if (strcmp(songs[thesong].extnotetype[a],"27")==0||strcmp(songs[thesong].extnotetype[a],"g7")==0){
							if (g1rgbts>=testmeasure-(almostlv*currbpm/150)&&!songs[thesong].g1extnoteplayed[a]){
								if (!grgb){
									playsound(marmot+256,volguit);
									songs[thesong].g1extnoteplayed[a]=true;
									grgb=true;
						...
						if (strcmp(songs[thesong].extnotetype[a],"28")==0||strcmp(songs[thesong].extnotetype[a],"gw")==0){
							if (g1wts>=testmeasure-(almostlv*currbpm/150)&&!songs[thesong].g1extnoteplayed[a]){
								if (!gw){
									playsound(marmot+256,volguit);
									songs[thesong].g1extnoteplayed[a]=true;
									gw=true;
