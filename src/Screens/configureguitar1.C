...
*/
void configureguitar1(){
	#ifdef EXCESSIVE
	printf("configureguitar1\n");
	#endif
	...
	sprintf(optionv[0], "%s", keytochar(guitar1r));
	sprintf(optionv[1], "%s", keytochar(guitar1g));
	sprintf(optionv[2], "%s", keytochar(guitar1b));
	sprintf(optionv[3], "%s", keytochar(guitar1w));
	sprintf(optionv[4], "%s", keytochar(guitar1p));
	sprintf(optionv[5], "%s", keytochar(guitar1start));
	sprintf(optionv[6], "%s", keytochar(guitar1back));
	sprintf(optionv[7], "%s", keytochar(guitar1a));
