...
*/
void playnote_g1bas(int a,bool &gb,bool &gg,bool &ggb,bool &gr,bool &grb,bool &grg,bool &grgb,bool &gw,bool &go){
	#ifdef EXCESSIVE
	printf("playnote_g1bas\n");
	#endif
	if (guitar1treb){
		if (guit1diff==0){
			...
			if (testmeasure+(almostlv*currbpm/150)<songposition+(entiresongoffset*currbpm)){
				if (!songs[thesong].g1basnoteplayed[a]){
					if (songs[thesong].basnotesound[a]!=NULL){
						...
						if (strcmp(songs[thesong].basnotetype[a],"20")==0||strcmp(songs[thesong].basnotetype[a],"g0")==0){
							if (!songs[thesong].g1basnoteplayed[a]){
								...
								songs[thesong].g1basnoteplayed[a]=true;
			...
			if (testmeasure-(almostlv*currbpm/150)<songposition+(entiresongoffset*currbpm)){
				if (!songs[thesong].g1basnoteplayed[a]){
					if (songs[thesong].basnotesound[a]!=NULL){
						...
						if (strcmp(songs[thesong].basnotetype[a],"20")==0||strcmp(songs[thesong].basnotetype[a],"g0")==0){
							if (g1ots>=testmeasure-(almostlv*currbpm/150)&&!songs[thesong].g1basnoteplayed[a]){
								if (!go){
						...
						if (strcmp(songs[thesong].basnotetype[a],"21")==0||strcmp(songs[thesong].basnotetype[a],"g1")==0){
							if (g1bts>=testmeasure-(almostlv*currbpm/150)&&!songs[thesong].g1basnoteplayed[a]){
								if (!gb){
									playsound(marmot+256,volguit);
									songs[thesong].g1basnoteplayed[a]=true;
									gb=true;
						...
						if (strcmp(songs[thesong].basnotetype[a],"22")==0||strcmp(songs[thesong].basnotetype[a],"g2")==0){
							if (g1gts>=testmeasure-(almostlv*currbpm/150)&&!songs[thesong].g1basnoteplayed[a]){
								if (!gg){
									playsound(marmot+256,volguit);
									songs[thesong].g1basnoteplayed[a]=true;
									gg=true;
						...
						if (strcmp(songs[thesong].basnotetype[a],"23")==0||strcmp(songs[thesong].basnotetype[a],"g3")==0){
							if (g1gbts>=testmeasure-(almostlv*currbpm/150)&&!songs[thesong].g1basnoteplayed[a]){
								if (!ggb){
									playsound(marmot+256,volguit);
									songs[thesong].g1basnoteplayed[a]=true;
									ggb=true;
						...
						if (strcmp(songs[thesong].basnotetype[a],"24")==0||strcmp(songs[thesong].basnotetype[a],"g4")==0){
							if (g1rts>=testmeasure-(almostlv*currbpm/150)&&!songs[thesong].g1basnoteplayed[a]){
								if (!gr){
									playsound(marmot+256,volguit);
									songs[thesong].g1basnoteplayed[a]=true;
									gr=true;
						...
						if (strcmp(songs[thesong].basnotetype[a],"25")==0||strcmp(songs[thesong].basnotetype[a],"g5")==0){
							if (g1rbts>=testmeasure-(almostlv*currbpm/150)&&!songs[thesong].g1basnoteplayed[a]){
								if (!grb){
									playsound(marmot+256,volguit);
									songs[thesong].g1basnoteplayed[a]=true;
									grb=true;
						...
						if (strcmp(songs[thesong].basnotetype[a],"26")==0||strcmp(songs[thesong].basnotetype[a],"g6")==0){
							if (g1rgts>=testmeasure-(almostlv*currbpm/150)&&!songs[thesong].g1basnoteplayed[a]){
								if (!grg){
									playsound(marmot+256,volguit);
									songs[thesong].g1basnoteplayed[a]=true;
									grg=true;
						...
						if (strcmp(songs[thesong].basnotetype[a],"27")==0||strcmp(songs[thesong].basnotetype[a],"g7")==0){
							if (g1rgbts>=testmeasure-(almostlv*currbpm/150)&&!songs[thesong].g1basnoteplayed[a]){
								if (!grgb){
									playsound(marmot+256,volguit);
									songs[thesong].g1basnoteplayed[a]=true;
									grgb=true;
						...
						if (strcmp(songs[thesong].basnotetype[a],"28")==0||strcmp(songs[thesong].basnotetype[a],"gw")==0){
							if (g1wts>=testmeasure-(almostlv*currbpm/150)&&!songs[thesong].g1basnoteplayed[a]){
								if (!gw){
									playsound(marmot+256,volguit);
									songs[thesong].g1basnoteplayed[a]=true;
									gw=true;
