...
*/
void playnote_g2bas(int a,bool &gb,bool &gg,bool &ggb,bool &gr,bool &grb,bool &grg,bool &grgb,bool &gw,bool &go){
	#ifdef EXCESSIVE
	printf("playnote_g2bas\n");
	#endif
	if (guitar2treb){
		if (guit2diff==0){
			long int testmeasure=99999999;//to ignore the nbas line.
			if (songs[thesong].basnotetime[a]>=0&&songs[thesong].basnotetime[a]<=100000){
				if (songs[thesong].basnotemeas[a]>=0&&songs[thesong].basnotemeas[a]<=999){
					testmeasure=(songs[thesong].basnotemeas[a]*240000+int((double(songs[thesong].basnotetime[a])/10000.0)*240000.0))+(notesoundoffset*currbpm)-(songs[thesong].offset*500);
				}
			}
			//printf("the measure: %i the timing: %i all together: %i ||",songs[thesong].basnotemeas[a]*240000,songs[thesong].basnotetime[a],testmeasure);
			...
			if (testmeasure+(almostlv*currbpm/150)<songposition+(entiresongoffset*currbpm)){
				if (!songs[thesong].g2basnoteplayed[a]){
					if (songs[thesong].basnotesound[a]!=NULL){
						...
						if (strcmp(songs[thesong].basnotetype2[a],"20")==0||strcmp(songs[thesong].basnotetype2[a],"g0")==0){
							if (!songs[thesong].g2basnoteplayed[a]){
								...
								songs[thesong].g2basnoteplayed[a]=true;
			...
			if (testmeasure-(almostlv*currbpm/150)<songposition+(entiresongoffset*currbpm)){
				if (!songs[thesong].g2basnoteplayed[a]){
					if (songs[thesong].basnotesound[a]!=NULL){
						int marmot=alphatoi(songs[thesong].basnotesound[a]);
						if (strcmp(songs[thesong].basnotetype2[a],"20")==0||strcmp(songs[thesong].basnotetype2[a],"g0")==0){
							if (g2ots>=testmeasure-(almostlv*currbpm/150)&&!songs[thesong].g2basnoteplayed[a]){
								if (!go){
						...
						if (strcmp(songs[thesong].basnotetype2[a],"21")==0||strcmp(songs[thesong].basnotetype2[a],"g1")==0){
							if (g2bts>=testmeasure-(almostlv*currbpm/150)&&!songs[thesong].g2basnoteplayed[a]){
								if (!gb){
									playsound(marmot+256,volbass);
									songs[thesong].g2basnoteplayed[a]=true;
									gb=true;
						...
						if (strcmp(songs[thesong].basnotetype2[a],"22")==0||strcmp(songs[thesong].basnotetype2[a],"g2")==0){
							if (g2gts>=testmeasure-(almostlv*currbpm/150)&&!songs[thesong].g2basnoteplayed[a]){
								if (!gg){
									playsound(marmot+256,volbass);
									songs[thesong].g2basnoteplayed[a]=true;
									gg=true;
						...
						if (strcmp(songs[thesong].basnotetype2[a],"23")==0||strcmp(songs[thesong].basnotetype2[a],"g3")==0){
							if (g2gbts>=testmeasure-(almostlv*currbpm/150)&&!songs[thesong].g2basnoteplayed[a]){
								if (!ggb){
									playsound(marmot+256,volbass);
									songs[thesong].g2basnoteplayed[a]=true;
									ggb=true;
						...
						if (strcmp(songs[thesong].basnotetype2[a],"24")==0||strcmp(songs[thesong].basnotetype2[a],"g4")==0){
							if (g2rts>=testmeasure-(almostlv*currbpm/150)&&!songs[thesong].g2basnoteplayed[a]){
								if (!gr){
									playsound(marmot+256,volbass);
									songs[thesong].g2basnoteplayed[a]=true;
									gr=true;
						...
						if (strcmp(songs[thesong].basnotetype2[a],"25")==0||strcmp(songs[thesong].basnotetype2[a],"g5")==0){
							if (g2rbts>=testmeasure-(almostlv*currbpm/150)&&!songs[thesong].g2basnoteplayed[a]){
								if (!grb){
									playsound(marmot+256,volbass);
									songs[thesong].g2basnoteplayed[a]=true;
									grb=true;
						...
						if (strcmp(songs[thesong].basnotetype2[a],"26")==0||strcmp(songs[thesong].basnotetype2[a],"g6")==0){
							if (g2rgts>=testmeasure-(almostlv*currbpm/150)&&!songs[thesong].g2basnoteplayed[a]){
								if (!grg){
									playsound(marmot+256,volbass);
									songs[thesong].g2basnoteplayed[a]=true;
									grg=true;
						...
						if (strcmp(songs[thesong].basnotetype2[a],"27")==0||strcmp(songs[thesong].basnotetype2[a],"g7")==0){
							if (g2rgbts>=testmeasure-(almostlv*currbpm/150)&&!songs[thesong].g2basnoteplayed[a]){
								if (!grgb){
									playsound(marmot+256,volbass);
									songs[thesong].g2basnoteplayed[a]=true;
									grgb=true;
						...
						if (strcmp(songs[thesong].basnotetype2[a],"28")==0||strcmp(songs[thesong].basnotetype2[a],"gw")==0){
							if (g2wts>=testmeasure-(almostlv*currbpm/150)&&!songs[thesong].g2basnoteplayed[a]){
								if (!gw){
									playsound(marmot+256,volbass);
									songs[thesong].g2basnoteplayed[a]=true;
									gw=true;
