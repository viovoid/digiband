...
*/
void playnote_g2adv(int a,bool &gb,bool &gg,bool &ggb,bool &gr,bool &grb,bool &grg,bool &grgb,bool &gw,bool &go){
	#ifdef EXCESSIVE
	printf("playnote_g2adv\n");
	#endif
	if (guitar2treb){
		if (guit2diff==1){
			...
			if (testmeasure+(almostlv*currbpm/150)<songposition+(entiresongoffset*currbpm)){
				if (!songs[thesong].g2advnoteplayed[a]){
					if (songs[thesong].advnotesound[a]!=NULL){
						...
						if (strcmp(songs[thesong].advnotetype2[a],"20")==0||strcmp(songs[thesong].advnotetype2[a],"g0")==0){
							if (!songs[thesong].g2advnoteplayed[a]){
								...
								songs[thesong].g2advnoteplayed[a]=true;
			...
			if (testmeasure-(almostlv*currbpm/150)<songposition+(entiresongoffset*currbpm)){
				if (!songs[thesong].g2advnoteplayed[a]){
					if (songs[thesong].advnotesound[a]!=NULL){
						...
						if (strcmp(songs[thesong].advnotetype2[a],"20")==0||strcmp(songs[thesong].advnotetype2[a],"g0")==0){
							if (g2ots>=testmeasure-(almostlv*currbpm/150)&&!songs[thesong].g2advnoteplayed[a]){
								if (!go){
						...
						if (strcmp(songs[thesong].advnotetype2[a],"21")==0||strcmp(songs[thesong].advnotetype2[a],"g1")==0){
							if (g2bts>=testmeasure-(almostlv*currbpm/150)&&!songs[thesong].g2advnoteplayed[a]){
								if (!gb){
									playsound(marmot+256,volbass);
									songs[thesong].g2advnoteplayed[a]=true;
									gb=true;
						...
						if (strcmp(songs[thesong].advnotetype2[a],"22")==0||strcmp(songs[thesong].advnotetype2[a],"g2")==0){
							if (g2gts>=testmeasure-(almostlv*currbpm/150)&&!songs[thesong].g2advnoteplayed[a]){
								if (!gg){
									playsound(marmot+256,volbass);
									songs[thesong].g2advnoteplayed[a]=true;
									gg=true;
						...
						if (strcmp(songs[thesong].advnotetype2[a],"23")==0||strcmp(songs[thesong].advnotetype2[a],"g3")==0){
							if (g2gbts>=testmeasure-(almostlv*currbpm/150)&&!songs[thesong].g2advnoteplayed[a]){
								if (!ggb){
									playsound(marmot+256,volbass);
									songs[thesong].g2advnoteplayed[a]=true;
									ggb=true;
						...
						if (strcmp(songs[thesong].advnotetype2[a],"24")==0||strcmp(songs[thesong].advnotetype2[a],"g4")==0){
							if (g2rts>=testmeasure-(almostlv*currbpm/150)&&!songs[thesong].g2advnoteplayed[a]){
								if (!gr){
									playsound(marmot+256,volbass);
									songs[thesong].g2advnoteplayed[a]=true;
									gr=true;
						...
						if (strcmp(songs[thesong].advnotetype2[a],"25")==0||strcmp(songs[thesong].advnotetype2[a],"g5")==0){
							if (g2rbts>=testmeasure-(almostlv*currbpm/150)&&!songs[thesong].g2advnoteplayed[a]){
								if (!grb){
									playsound(marmot+256,volbass);
									songs[thesong].g2advnoteplayed[a]=true;
									grb=true;
						...
						if (strcmp(songs[thesong].advnotetype2[a],"26")==0||strcmp(songs[thesong].advnotetype2[a],"g6")==0){
							if (g2rgts>=testmeasure-(almostlv*currbpm/150)&&!songs[thesong].g2advnoteplayed[a]){
								if (!grg){
									playsound(marmot+256,volbass);
									songs[thesong].g2advnoteplayed[a]=true;
									grg=true;
						...
						if (strcmp(songs[thesong].advnotetype2[a],"27")==0||strcmp(songs[thesong].advnotetype2[a],"g7")==0){
							if (g2rgbts>=testmeasure-(almostlv*currbpm/150)&&!songs[thesong].g2advnoteplayed[a]){
								if (!grgb){
									playsound(marmot+256,volbass);
									songs[thesong].g2advnoteplayed[a]=true;
									grgb=true;
						...
						if (strcmp(songs[thesong].advnotetype2[a],"28")==0||strcmp(songs[thesong].advnotetype2[a],"gw")==0){
							if (g2wts>=testmeasure-(almostlv*currbpm/150)&&!songs[thesong].g2advnoteplayed[a]){
								if (!gw){
									playsound(marmot+256,volbass);
									songs[thesong].g2advnoteplayed[a]=true;
									gw=true;
