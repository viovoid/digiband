...
void loadtextureresize(){
	...
	for (int c=17;c<22;c++){
	    for (int b=0;b<int(texani[c][0]);b++){
			if (g_Texture[c][b]>0){
                if (glIsTexture(g_Texture[c][b])){
	            	glDeleteTextures(1,&g_Texture[c][b]);
					g_Texture[c][b]=0;
				}
			}
		}
...
void loadtextureondemand(){
	...
	return;
	if (currscreen==7||currscreen==8||currscreen==9||currscreen==10||currscreen==11||currscreen==17){
		if (prevscreen==2){
			return;
		}
	}
	if (currscreen==2){
		if (prevscreen==7||prevscreen==8||prevscreen==9||prevscreen==10||prevscreen==11||prevscreen==17){
			return;
		}
	}
	for (int a=0;a<numoftexs;a++){
	...
	if (currscreen==1||currscreen==2||currscreen==7||currscreen==8||currscreen==9||currscreen==10||currscreen==11||currscreen==17){
	...
	if (currscreen==2||currscreen==7||currscreen==8||currscreen==9||currscreen==10||currscreen==11||currscreen==17){
