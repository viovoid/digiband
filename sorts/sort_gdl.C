...
void sort_gdl(){
	...
	snprintf(curcatlist[0],255,"guitar level: 10-20");
	snprintf(curcatlist[1],255,"guitar level: 21-30");
	snprintf(curcatlist[2],255,"guitar level: 31-40");
	snprintf(curcatlist[3],255,"guitar level: 41-50");
	snprintf(curcatlist[4],255,"guitar level: 51-60");
	snprintf(curcatlist[5],255,"guitar level: 61-70");
	snprintf(curcatlist[6],255,"guitar level: 71-80");
	snprintf(curcatlist[7],255,"guitar level: 81-90");
	snprintf(curcatlist[8],255,"guitar level: 91-100");
	...
	for (int a=0;a<gbsongcount;a++){
		if (drummode&&!guitar1mode&&!guitar2mode){
			if(songs[a].drumbasdiff>0||songs[a].drumadvdiff>0||songs[a].drumextdiff>0){
				int currdiff=songs[a].lowestguitdiff;
				bool addother=true;
